...
test_that("Error messages are returned for erroneous input in the Dijkstra algorithm.", {
  wiki_wrong_graph <- wiki_graph
  names(wiki_wrong_graph) <- c("v1", "v3", "w")  # corrected column name error for accurate testing
